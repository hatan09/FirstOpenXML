...
namespace FirstOpenXML.Api.Controllers
{
    ...
    public class HTMLController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetHtmlFromDocx(IFormFile file)
        {
            ...
            var stream = System.IO.File.Open(filePath, FileMode.OpenOrCreate);
            st = stream;
            return File(st, "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "file.docx");
        }
    }
}
